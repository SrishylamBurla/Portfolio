    ...
    <footer className="bg-black text-white">
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        <div className="flex flex-col md:flex-row items-items-start space-y-6 py-10">
          <div className="flex-1 px-4">
            ...
            <p className="text-sm max-w-md text-gray-400">
              Full Stack Developer based in Hyderabad, specializing in web
        ...
        <div className="border-t border-gray-600 pt-4 flex flex-col md:flex-row lg:flex-row justify-between items-center">
            <p className="text-gray-400 text-xs">&copy; {new Date().getFullYear()} srishylam Burla All rights reserved</p>
            <div className="flex space-x-4 my-4 md:mb-4">
                <a href="www.whatsapp.com" className="text-green-400"><FaWhatsapp /></a>
                <a href="www.facebook.com" className="text-blue-500"><FaFacebook /></a>
                <a href="www.instagram.com" className="text-pink-500"><FaInstagram /></a>
                <a href="https://github.com/SrishylamBurla" className="text-gray-500"><FaGithub /></a>

            </div>
            <div className="flex space-x-4 text-xs">
                <a href="#privacy" className="text-gray-400 hover:text-white">Privacy</a>
                <a href="#services" className="text-gray-400 hover:text-white">Terms of service</a>
            </div>
        </div>
      </div>
    </footer>
