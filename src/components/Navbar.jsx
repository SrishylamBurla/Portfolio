const Navbar = () => {
  return (
    <nav className='bg-black text-white px-8 md:px-10 flex justify-center' >
        <div className="container flex justify-between items-center py-6">
            ...
            <div className="space-x-6">
                ...
                <a href="#contact" className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-red-500">Contact</a>
            </div>
