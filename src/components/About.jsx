...
const About = () => {
  ...
  return (
    <div className="bg-black text-white py-24">
      ...
      {activeTab === "education" ? (
        <div className="space-y-4 grid grid-cols-1 justify-items-center mt-20 mb-10">
          <div className="border border-emerald-400 rounded-lg p-4 w-full max-w-2xl bg-[#1a1a1a]">
            ...
            <p className="text-gray-400">Electronics and Communication Engineering – St.Mary's Engineering College (2015–2019)</p>
        ...
        <div className="space-y-4 grid grid-cols-1 justify-items-center mt-20">
          <div className="border border-emerald-400 rounded-lg p-4 w-full max-w-2xl bg-[#1a1a1a]">
